...
import { auth as firebaseAuth, db as firebaseDb, app as firebaseApp } from '../firebase/firebaseConfig';
...
export const checkFirebaseConnection = async () => {
  ...
  try {
    ...
    console.log('Auth initialized:', auth.app === app);
    
    // Check Firestore
    console.log('Firestore instance:', !!db);
    console.log('Firestore initialized:', db.app === app);
